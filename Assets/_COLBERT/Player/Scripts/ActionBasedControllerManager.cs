...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    public class ActionBasedControllerManager : MonoBehaviour
    {
        ...
        public Hand HandNode { get => hand; set => hand = value; }
        ...
        private void Update()
        {
            if (GetInputAction(m_TeleportModeCancel).IsPressed())
            {
            ...
            if (GetInputAction(m_TeleportModeCancel).WasReleasedThisFrame())
            {
